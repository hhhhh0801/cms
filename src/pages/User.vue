<template>
	<div class="user">
		...
		<el-dialog title="添加用户":visible.sync="dialogVisible"> 
			<el-form :model="user.form" :rules="rules" ref="ruleForm">
		    ...
		    <el-form-item label="确认密码" label-width="120px" >
		  	...
		  	<el-form-item label="真实姓名" label-width="120px" prop="nickname">
		    ...
		    <el-form-item>
			    <el-button type="primary" @click="submitForm('ruleForm')" class='dialogBtns'>确定</el-button>
			    <el-button @click="closeUserDialog" class='dialogBtns'>取消</el-button>
		    </el-form-item>
		  </el-form>
		</el-dialog>
	</div>
